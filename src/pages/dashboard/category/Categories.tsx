...
const columns: ColumnDef<Category>[] = [
    ...
    },
    {
        ...
        header: "Category",
        cell: ({ row }) => <div className="lowercase">{row.getValue("productCategory")}</div>,
    },
    {
        accessorKey: "action",
        header: "Action",
            ...
            <div className="py-4 flex items-center justify-between">
                ...
                <div className="flex gap-4 items-center justify-between">
                    <Input
                        ...
                        value={(table.getColumn("productCategory")?.getFilterValue() as string) ?? ""}
                        onChange={(event) =>
                            table.getColumn("productCategory")?.setFilterValue(event.target.value)
                        }
                        className="max-w-sm"
                    />
                    <CetegoryDialog >
